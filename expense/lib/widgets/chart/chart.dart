...
class Chart extends StatelessWidget {
  ...
  List<ExpenseBucket> get buckets {
    return [
      ...
      ExpenseBucket.forCategory(expenses, Category.bazar),
      ...
      ExpenseBucket.forCategory(expenses, Category.cigarette),
      ExpenseBucket.forCategory(expenses, Category.rent),
      ExpenseBucket.forCategory(expenses, Category.utility),
      ExpenseBucket.forCategory(expenses, Category.wifi),
      ExpenseBucket.forCategory(expenses, Category.travel),
      ExpenseBucket.forCategory(expenses, Category.fuel),
